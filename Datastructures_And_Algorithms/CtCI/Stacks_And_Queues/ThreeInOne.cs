...
namespace Datastructures_And_Algorithms.CtCI.Stacks_And_Queues
{
    public class ThreeInOne
    {
        ...
        public void Run()
        {
            ...
            fixedMultiStack.Push(1, "item 1.1");
            fixedMultiStack.Push(1, "item 1.2");
            fixedMultiStack.Push(1, "item 1.3");

            // Stack two operations
            fixedMultiStack.Push(2, "item 2.1");
            fixedMultiStack.Push(2, "item 2.2");
            fixedMultiStack.Push(2, "item 2.3");

            // Stack three operations
            fixedMultiStack.Push(3, "item 3.1");
            fixedMultiStack.Push(3, "item 3.2");
            fixedMultiStack.Push(3, "item 3.3");

            // Stack one operations
            var remove = fixedMultiStack.Pop(1);
            Console.WriteLine($"remove={remove}");

            remove = fixedMultiStack.Pop(1);
            Console.WriteLine($"remove={remove}");
